...
def test_phase2_task17_queue_age_safe_fallback_contract_fields_are_deterministic() -> None:
    ...
    runner = BenchRunner(
        ...
        safety=BenchSafetyConfig(max_queue_age_ms=20.0),
    )
