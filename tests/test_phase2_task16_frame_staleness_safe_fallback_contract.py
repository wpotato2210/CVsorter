...
def test_phase2_task16_frame_staleness_safe_fallback_contract_fields_are_deterministic() -> None:
    ...
    runner = BenchRunner(
        ...
        safety=BenchSafetyConfig(max_frame_staleness_ms=20.0),
    )
    ...
    assert log.nack_detail == "FRAME_STALENESS_EXCEEDED"
