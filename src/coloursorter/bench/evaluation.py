    ...
    with events_path.open("w", encoding="utf-8") as handle:
        for entry in logs:
            ...
            payload = {
                ...
                "pipeline_latency_ms": entry.pipeline_latency_ms,
                "trigger_offset_ms": entry.trigger_offset_ms,
                "actuation_delay_ms": entry.actuation_delay_ms,
        ...
        for entry in logs:
            ...
            writer.writerow(
                [
                    ...
                    f"{entry.frame_timestamp_ms:.3f}",
                    f"{entry.pipeline_latency_ms:.3f}",
                    f"{entry.trigger_offset_ms:.3f}",
                    f"{entry.actuation_delay_ms:.3f}",
